    ...
    <div class="container">
      <div class="heading-content" style="background: url({{url('/themes/blog/assets/images/learning-paths-heading.png')}}) right bottom no-repeat;"> 
        <div class="heading-text"> 
          ...
          <p>Pick one of our selected learning paths, and get started today!
</p>
        </div>
      </div>
    </div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="list-item col-sm-12">
				<div class="media">
					<a class="media-left" href="{{ route('public.learn.detail', $feature_item->slug) }}">
					...
					<div class="media-body">
						<h3 class="path-title media-heading">
							<a href="{{ route('public.learn.detail', $feature_item->slug) }}">{{ $feature_item->name }}</a>
						</h3>
						<!-- <p class="path-stats">
