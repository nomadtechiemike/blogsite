				...
				<form id="register" class="register-form" autocomplete="off" tabindex="-1">
					...
					<div class="form-field email-email">
						...
						<label for="register-email"> Email *</label> <input
							...
							class="input-block " aria-describedby="register-email-desc"
							minlength="3" maxlength="254" aria-required="true" required=""
							placeholder="username@domain.com" value="">
					...
					<div class="form-field text-username">
						...
						<label for="register-username"> Public username *</label> <input
							...
							class="input-block " aria-describedby="register-username-desc"
							minlength="2" maxlength="30" aria-required="true" required=""
							placeholder="JaneDoe" value=""> <span class="tip tip-input"
							id="register-username-desc">The name that will identify you in
							your courses - <strong>(cannot be changed later)</strong>
						</span>
					...
					<div class="form-field text-name">
						...
						<label for="register-name"> Full name *</label> <input
							id="register-name" type="text" name="name" class="input-block "
							aria-describedby="register-name-desc" maxlength="255"
							aria-required="true" required="" placeholder="Jane Doe" value="">

						<span class="tip tip-input" id="register-name-desc">Your legal
							name, used for any certificates you earn.</span>
					...
					<div class="form-field select-country">
						...
						<label for="register-country"> Country </label> <select
							id="register-country" name="country" class="input-inline"
							aria-describedby="register-country-desc"
							data-errormsg-required="Please select your Country.">
